...
namespace livraria.api.mode.Model.Response
{
    ...
    public class LivrosResponseModelExample : IExamplesProvider
    {
    ...
    public class TodosLivrosResponse400 : IExamplesProvider
    {
        public object GetExamples()
        {
    ...
    public class GetLivroResponse400 : IExamplesProvider
    {
        public object GetExamples()
        {
            List<string> listaCodigos = new List<string> { "M199", "M0001" };
    ...
    public class PostLivroResponse400 : IExamplesProvider
    {
        public object GetExamples()
        {
    ...
    public class DeleteLivroResponse400 : IExamplesProvider
    {
        public object GetExamples()
        {
    ...
    public class UpdateLivroResponse400 : IExamplesProvider
    {
        public object GetExamples()
        {
            List<string> listaCodigos = new List<string> { "M199", "M0001", "M0005" };
